...
const CACHE = 'planeta-20260906212551'; // bumped automatically by deploy.py
const FILES = ['./', './index.html', './style.css', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png',
  './js/main.js', './js/game.js', './js/audio.js', './js/i18n.js', './js/themes.js', './js/storage.js', './js/rng.js', './js/share.js',
