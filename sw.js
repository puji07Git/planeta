...
const CACHE = 'planeta-20260906224133'; // bumped automatically by deploy.py
const FILES = ['./', './index.html', './style.css', './manifest.webmanifest', './icon.svg', './icon-192.png', './icon-512.png',
  './js/main.js', './js/game.js', './js/audio.js', './js/i18n.js', './js/themes.js', './js/storage.js', './js/rng.js', './js/share.js', './js/journey.js', './js/encounters.js',
...
self.addEventListener('fetch', (e) => {
  ...
  e.respondWith(fetch(req).then((r) => { if (r && r.ok) { const copy = r.clone(); caches.open(CACHE).then((c) => c.put(req, copy)); } return r; })
